...
# Compress, rename and store appointment completion proof photo under uploads/appointments/mr/{appointment_id}/.
def save_mr_appointment_completion_photo(upload_file: UploadFile, appointment_id: str) -> str:
    base_dir = os.path.join("uploads", "appointments", "mr", appointment_id)
...
def delete_mr_appointment_assets(appointment_id: str) -> None:
    base_dir = os.path.join("uploads", "appointments", "mr", appointment_id)
